    ...
    <React.Fragment>
      ...
      <div className="page-content">
        <div className="container-fluid">
          <Breadcrumbs title="User Management" breadcrumbItem={isUserEdit ? "User Information" : "User Search"} />
          {isUserEdit ? (
            <UserEditCard setIsBlockModal={setIsBlockModal} isBlockModal={isBlockModal} setIsUserEdit={setIsUserEdit} />
          ) : (
            <Row>
              <Col xs="12">
                <Card>
            ...
            <ModalBody>
                <Row>
                  <Col className="col-12">
                    <textarea className="w-100" rows="10" placeholder="Enter the reason.">
                    </textarea>
